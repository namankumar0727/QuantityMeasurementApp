 ...
 * support. This test class validates the functionality of the REST API endpoints in the
 * application by starting the application context and making real HTTP requests to the API.
 * The tests cover various scenarios for
 * a. comparing quantities (e.g., 1 foot equals 12 inches),
 * b. converting quantities (e.g., 100 Celsius to Fahrenheit),
 * c. adding quantities (e.g., 1 gallon plus 3.785 litres),
 * d. retrieving operation history and counts, and
 * e. error handling scenarios (e.g., dividing by zero).
 */
